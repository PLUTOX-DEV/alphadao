...
const About = () => (
  ...
  >
    <div className="sticky top-0 z-50 border-b border-black bg-gray-950">
      <Header />
    </div>
    ...
    >
      <main className="container mx-auto px-4 py-16">
        ...
        <section className="text-center mt-8 mb-20">
          <div className="bg-gray-950 opacity-90 rounded-xl">
            <p className="text-lg text-white mx-auto mb-8 p-6 font-medium">
          ...
          <Link
            to="/contactus"
            className="inline-block px-8 py-3 bg-gradient-to-r from-purple-700 to-purple-950 text-white font-bold rounded-lg shadow-lg hover:from-purple-800 hover:to-purple-900 transition"
          >
            Get in Touch
          </Link>
        </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            {teamMembers.map((member) => (
              ...
              >
                ...
                <p className="text-purple-500 font-medium mb-2 text-center">{member.role}</p>
                {member.twitter && (
                  <a
                    href={`https://twitter.com/${member.twitter}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-400 hover:text-blue-600 flex items-center gap-2 mt-1"
